...
Ролі: `admin` бачить усе й може видаляти заявки та робити копію бази;
`teacher` бачить заявки, друкує списки й видає учням паролі, але не видаляє
й не вивантажує базу.
